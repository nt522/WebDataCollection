...
public class Main_test1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			String source;
			File file = new
			File("C:/Users/kyungmyung/Desktop/test.csv");
			...
			try {
			title =
			driver.findElement(By.xpath("/html/body/div[5]/div/div[11]/div/div[2]/div[2]/div/div/div/div/div["+Integer.toString(i)+"]/div/div/a/div/div[2]/div[2]")).getText();
			String[] result = {title};
			...
			writer.close();
			///html/body/div[5]/div/div[11]/div/div[4]/div/div[3]/table/tbody/tr
			/td[3]/a
			///html/body/div[5]/div/div[11]/div/div[4]/div/div[3]/table/tbody/tr
			/td[11]/a
			}
